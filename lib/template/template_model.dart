...
class TemplateModel with TemplateView {
  ...
  void setValue(String filedName, value, [type = '']) {
    switch (type) {
      case 'int':
  ...
  bool isFilter(String field, [bool isReport = false]) {
    if (!isReport) {
      if (getListViewTemplate()['field_filter'] == null) {
        ...
        return ((getListViewTemplate()['field_filter'] as List)
            .contains(field));
      }
    } else {
      if (getListViewTemplate()['field_not_filter'] == null) {
        ...
        return (!(getListViewTemplate()['field_not_filter'] as List)
            .contains(field));
      }
    }
  }
  ...
  bool isSort(String field) {
    if (getListViewTemplate()['field_not_sort'] == null) {
      ...
      return (!(getListViewTemplate()['field_not_sort'] as List)
          .contains(field));
    }
  }
